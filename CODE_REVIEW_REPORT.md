...
**项目名称**：东软颐养中心管理系统  
**技术栈**：Spring Boot 3.1.12 + Vue3 + MySQL + MyBatis-Plus + JWT  
**审查日期**：2026-05-21  
...
```yaml
jwt:
  secret: ${JWT_SECRET:elderly-care-secret-key-neusoft-2025}
...
# 生产环境强制要求环境变量，不使用默认值
jwt:
  secret: ${JWT_SECRET}  # 无默认值，启动时报错提醒
```
...
| 问题 | 修复方案 | 状态 |
|------|----------|------|
| JWT Secret 硬编码 | 使用 `${JWT_SECRET}` 环境变量 | ✅ 已修复 |
