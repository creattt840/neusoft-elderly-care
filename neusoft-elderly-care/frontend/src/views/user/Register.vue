  ...
  <div class="login-page">
    <div class="login-brand">
      ...
      <div class="brand-content">
        ...
        <p class="brand-subtitle">加入我们 · 开启智慧养老管理</p>
        <ul class="brand-features">
          <li><el-icon><CircleCheck /></el-icon> 快速注册管理账号</li>
          <li><el-icon><CircleCheck /></el-icon> 安全可靠的权限体系</li>
          <li><el-icon><CircleCheck /></el-icon> 一站式业务管理平台</li>
        </ul>
      </div>
    </div>
    ...
    <div class="login-panel">
      <div class="login-form-wrap">
        ...
        <el-form :model="form" :rules="rules" ref="formRef" class="login-form" label-position="top">
          ...
          <el-button type="primary" class="login-btn" size="large" :loading="loading" @click="handleRegister">
            注 册
          </el-button>
...
import { FirstAidKit, CircleCheck, Iphone, Lock, User } from '@element-plus/icons-vue'
